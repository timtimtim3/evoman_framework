...
if __name__ == '__main__':
    ...
    parser.add_argument('--npop', type=int, default=40, help='Population size')
    ...
    parser.add_argument('--mutation_std', type=float, default=0.1, help='Standard deviation for mutation')
    parser.add_argument('--mutation_std_end', type=float, default=0.01, help='Ending standard deviation for mutation')
    ...
    parser.add_argument('--learnable_mutation', type=bool, default=False, help='Whether to learn the mutation rate and std')
    ...
    parser.add_argument('--elitism', type=int, default=0, help='If 0, no elitism is used, otherwise the amount given')
    parser.add_argument('--crossover_function', type=str, default='crossover_recombination', help='Type of crossover to use')
    parser.add_argument('--k_round_robin', type=int, default=3, help='Number of individuals to play against each other')
    parser.add_argument('--n_islands', type=int, default=2, help='Number of islands for migration')
